...
{
    [Obsolete("Prefer using Unity.Tiny.DefaultWorldInitialization instead. This type will be (RemovedAfter 2020-04-29).")]
    public static class DefaultTinyWorldInitialization
    {
        ...
        {
            return DefaultWorldInitialization.Initialize(worldName);
        }
        ...
        public static World InitializeWorld(string worldName)
        {
            return DefaultWorldInitialization.InitializeWorld(worldName);
        }
        ...
        public static void AddSystem(World world, ComponentSystemBase system, bool addSystemToGroup)
        {
            DefaultWorldInitialization.AddSystem(world, system, addSystemToGroup);
        }
    }
}
